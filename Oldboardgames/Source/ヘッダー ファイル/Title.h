...
#define CURSOR_PVP_X (SCREEN_SIZEX * PVP_X - (825 / 2.0 + 97 / 1.5) * SCREEN_SIZEX / STD_SCREENSIZEX)
#define CURSOR_EXIT_X (SCREEN_SIZEX * EXIT_X - (177 / 2.0 + 97 / 1.5) * SCREEN_SIZEX / STD_SCREENSIZEX)
